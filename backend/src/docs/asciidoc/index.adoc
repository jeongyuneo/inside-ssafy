...
===== 성공
.request
include::{snippets}/get-bus-likes-success/http-request.adoc[]

.response
include::{snippets}/get-bus-likes-success/http-response.adoc[]

===== 실패
.request
include::{snippets}/get-bus-likes-fail/http-request.adoc[]

.response
include::{snippets}/get-bus-likes-fail/http-response.adoc[]
