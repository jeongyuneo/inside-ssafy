...
===== 성공
.request
include::{snippets}/get-favorite-buses-success/http-request.adoc[]

.response
include::{snippets}/get-favorite-buses-success/http-response.adoc[]

===== 실패
.request
include::{snippets}/get-favorite-buses-fail/http-request.adoc[]

.response
include::{snippets}/get-favorite-buses-fail/http-response.adoc[]
