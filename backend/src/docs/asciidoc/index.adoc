...
===== 성공
.request
include::{snippets}/arrive-at-success/http-request.adoc[]

.response
include::{snippets}/arrive-at-success/http-response.adoc[]

===== 실패
.request
include::{snippets}/arrive-at-fail/http-request.adoc[]

.response
include::{snippets}/arrive-at-fail/http-response.adoc[]
